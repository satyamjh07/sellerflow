        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;background-color:${C.white};border-radius:16px;overflow:hidden;border:1px solid ${C.border}">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="vertical-align:top">
                    ...
                    ${user.gstNumber ? `<p style="margin:4px 0 0;font-size:11px;color:rgba(255,255,255,0.7);letter-spacing:0.3px"><span style="font-weight:700">GSTIN:</span> ${user.gstNumber}</p>` : ""}
                  </td>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td style="vertical-align:top;width:50%;padding-right:16px">
                    ...
                    ${user.gstNumber ? `<p style="margin:4px 0 0;font-size:11px;color:${C.textMuted};letter-spacing:0.3px"><span style="font-weight:700;color:${C.textPrimary}">GSTIN:</span> ${user.gstNumber}</p>` : ""}
                  </td>
                  <!-- Bill To -->
          ...
          <tr>
            <td style="padding:28px 32px;text-align:center;border-top:1px solid ${C.border};margin-top:24px">
              ...
              <p style="margin:20px 0 0;font-size:11px;color:${C.textLight}">Generated by <strong>Hisaab Mitra</strong> • hisaabmitra.in</p>
            </td>
          </tr>
